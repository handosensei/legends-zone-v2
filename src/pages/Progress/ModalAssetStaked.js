  ...
  <>
    ...
    <Modal id="modalAssetStaked" isOpen={modal_standard} toggle={() => { tog_standard(); }} >
      ...
      <ModalBody>
        ...
        <p className="text-muted"><a href="https://medium.com/@metalegends/meta-legends-public-mint-11th-december-86353b5dd7c0" target="_blank" rel="noreferrer">@medium</a></p>
      </ModalBody>
